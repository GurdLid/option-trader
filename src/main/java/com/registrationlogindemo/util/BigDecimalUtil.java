package com.registrationlogindemo.util;
...
public final class BigDecimalUtil {
    ...
    public static BigDecimal log10(BigDecimal b) {
        ...
        // so that I can round it correctly.
    ...
    public static BigDecimal cdf(BigDecimal z)
    {
        BigDecimal y = (new BigDecimal("-1.5976",MathContext.DECIMAL32)).multiply(z,MathContext.DECIMAL32);
        z = BigDecimalUtil.intPower(z,3,32);

        BigDecimal y2 = (new BigDecimal("-0.07056",MathContext.DECIMAL32)).multiply(z,MathContext.DECIMAL32);
        BigDecimal denom = y.add(y2);
        denom = (BigDecimalUtil.exp(denom,32)).add(new BigDecimal("1.0",MathContext.DECIMAL32));

        return (new BigDecimal("1.0",MathContext.DECIMAL32)).divide(denom,MathContext.DECIMAL32);
    }
